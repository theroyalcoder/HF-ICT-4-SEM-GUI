...
QT_MOC_LITERAL(1, 9, 12), // "gameFinished"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "mover"
QT_MOC_LITERAL(4, 29, 4) // "next"

    },
    "GameArea\0gameFinished\0\0mover\0next"
};
...
void GameArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GameArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameArea::gameFinished)) {
                *result = 0;
                return;
            }
        }
